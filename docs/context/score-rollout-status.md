...
1. [src/lib/jobs.ts](/Users/shs/Desktop/Study/ipo/src/lib/jobs.ts)에서 no-op 처리한 점수 sync / recalc helper를 원래 호출로 복구한다.
2. [src/lib/jobs.ts](/Users/shs/Desktop/Study/ipo/src/lib/jobs.ts) public read path에 `getPublicIpoScoreMap()` join을 다시 붙인다.
